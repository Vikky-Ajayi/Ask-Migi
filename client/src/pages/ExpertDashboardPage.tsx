    ...
    <ExpertLayout title="Dashboard" verified={isVerified} pendingCount={pendingCount}>
      <div className="px-4 md:px-8 py-6 flex flex-col gap-5">
        ...
        {!isVerified && !isInReview && (
          <div className="bg-[#0d2040] border border-[#1a3a6a] rounded-2xl px-5 py-5 flex flex-col gap-4">
            <div className="h-9 w-9 rounded-full border border-white/20 flex items-center justify-center shrink-0">
              <div className="h-4 w-4 rounded-full border-2 border-white/50" />
            </div>
            <div>
              <p className="text-lg font-bold text-white mb-2">Complete Your Verification</p>
            ...
            <button
              ...
              className="self-start h-10 px-5 rounded-full bg-[#2d7dd2] hover:bg-[#3a8de2] text-white font-semibold text-sm transition-colors whitespace-nowrap"
