  ...
  return (
    <main className="min-h-screen w-full bg-[#161618] text-white flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        {/* Main area with modal overlay */}
        <div className="flex flex-1 items-center justify-center px-4 py-12 relative">
          {/* Background hint (like the design shows the chat behind) */}
          <div className="absolute inset-0 flex items-start justify-end p-6 pointer-events-none opacity-10">
          </div>
          ...
          >
            ...
            <div className="flex gap-2 px-6 pb-4">
              <button
                ...
                className={`flex items-center gap-2 flex-1 h-10 rounded-xl text-sm font-medium transition-colors justify-center ${
                  tab === "profile"
                    ? "bg-[#2a2c2e] text-white border border-white/10"
              ...
              {tab === "change-password" && (
                <form className="flex flex-col gap-3" onSubmit={handleSave}>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full h-12 rounded-full bg-white text-black font-semibold text-sm hover:bg-white/90 transition-colors mt-2 disabled:opacity-60"
