  ...
  return (
    <main className="min-h-screen w-full bg-th-page text-th-text flex flex-col">
      ...
      <section className="flex flex-col items-center text-center px-5 pt-14 pb-4 md:pt-20 md:pb-6">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-th-text leading-tight max-w-2xl">
          Clear answers from people<br className="hidden md:block" /> who actually know.
        </h1>
        <p className="mt-5 text-sm md:text-base text-th-text-60 leading-7 max-w-lg">
        ...
        <div className="mt-8 flex items-center gap-3 flex-wrap justify-center">
          <button
            ...
            className="h-11 px-7 rounded-full bg-[#0f0f11] text-white font-semibold text-sm hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90 transition-colors"
          ...
          <button
            ...
            className="h-11 px-7 rounded-full border border-th-border-strong text-th-text font-semibold text-sm hover:bg-th-hover transition-colors"
      ...
      <section className="flex flex-col items-center px-5 pt-16 pb-12 md:pt-24 md:pb-5">
        <div className="text-center mb-12 md:mb-5 max-w-lg">
          <h2 className="text-3xl md:text-4xl font-black text-th-text">How it works</h2>
          <p className="mt-4 text-sm md:text-base text-th-text-60 leading-7">
        ...
        <div className="w-full max-w-2xl md:max-w-4xl flex flex-col gap-5 md:gap-6">
          ...
          <div className="self-start w-[85%] md:w-[75%]">
            <div className="bg-th-card-alt border border-th-border-md rounded-2xl px-6 py-6 flex items-start gap-5">
              <div className="shrink-0 w-10 h-10 rounded-full border border-th-border-strong flex items-center justify-center">
                <span className="text-xs font-bold text-th-text-70">01</span>
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-black text-th-text leading-tight">Ask your question</h3>
                <p className="mt-2 text-sm text-th-text-60 leading-6">
          ...
          <div className="self-end w-[85%] md:w-[75%]">
            <div className="bg-th-card-alt border border-th-border-md rounded-2xl px-6 py-6 flex items-start gap-5">
              <div className="shrink-0 w-10 h-10 rounded-full border border-th-border-strong flex items-center justify-center">
                <span className="text-xs font-bold text-th-text-70">02</span>
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-black text-th-text leading-tight">Expert reviews it</h3>
                <p className="mt-2 text-sm text-th-text-60 leading-6">
          ...
          <div className="self-start w-[85%] md:w-[75%]">
            <div className="bg-th-card-alt border border-th-border-md rounded-2xl px-6 py-6 flex items-start gap-5">
              <div className="shrink-0 w-10 h-10 rounded-full border border-th-border-strong flex items-center justify-center">
                <span className="text-xs font-bold text-th-text-70">03</span>
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-black text-th-text leading-tight">You get a real answer</h3>
                <p className="mt-2 text-sm text-th-text-60 leading-6">
      ...
      <section className="px-5 pb-12 md:pb-16">
        <div className="max-w-2xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={stat.label} className="rounded-2xl border border-th-border-md bg-th-sidebar p-5 text-center">
              <p className="text-2xl font-black text-th-text mb-1">{stat.value}</p>
              <p className="text-xs text-th-text-40">{stat.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="px-5 pb-16 md:pb-20">
        <div className="max-w-2xl mx-auto rounded-2xl border border-th-border-md bg-th-sidebar p-8 text-center">
          <h2 className="text-xl font-bold text-th-text mb-3">Ready to get real answers?</h2>
          <p className="text-sm text-th-text-60 leading-6 mb-6 max-w-lg mx-auto">
            Create a free account and ask your first questions.
            No commitment, no subscription — just expert answers when you need them.
          </p>
          <button
            onClick={() => setAuthView("register")}
            className="h-11 px-8 rounded-full bg-[#0f0f11] text-white font-semibold text-sm hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90 transition-colors"
