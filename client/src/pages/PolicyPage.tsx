...
const policies: Record<string, { title: string; effectiveDate: string; sections: Section[] }> = {
  disclaimer: {
    ...
    sections: [
      ...
      { heading: "1. Not Professional Advice", body: "AskMigi is an information and community platform where users can ask career-related questions and receive responses from certified career coaches. However, the information shared on AskMigi does not constitute legal, financial, or professional certification advice and should not be substituted for formal professional guidance.\n\nIf you require advice tailored to your specific situation, we strongly recommend consulting a qualified professional in the relevant field." },
      { heading: "2. No Professional Relationship", body: "Using AskMigi does not create a coach-client, consultant-client, or any other formal professional relationship between users and career coaches. Communications on the platform are not confidential and should not include sensitive or personally identifiable information beyond what is necessary." },
      { heading: "3. Accuracy and Reliability", body: "We strive to ensure that responses provided by career coaches are accurate and helpful. However:\n• We do not guarantee the correctness, completeness, or current validity of any information posted.\n• Career guidance, job markets, and industry standards may change over time, and responses may become outdated.\n• AskMigi is not responsible for any actions taken based on the information shared on the platform.\n• All information is provided \"as is\" without warranties of any kind, express or implied." },
      { heading: "4. Expert Verification", body: "Career coaches on AskMigi may be required to provide credentials, certifications, or proof of experience; however, AskMigi does not independently verify or guarantee the qualifications, licensing status, or professional conduct of any career coach." },
      { heading: "5. User Responsibility", body: "You are solely responsible for how you use the information provided on AskMigi. By using this site, you agree not to rely solely on AskMigi for making important decisions regarding your career, employment, or professional development." },
  ...
  terms: {
    ...
    sections: [
      ...
      { heading: "2. Use of the Platform", body: "AskMigi provides a platform for connecting users with career coaches. You agree to use the platform only for lawful purposes and in a way that does not infringe the rights of others." },
      ...
      { heading: "5. Expert Content", body: "The information provided by career coaches is for informational and educational purposes only and does not constitute legal, financial, or professional certification advice. AskMigi does not guarantee the accuracy or completeness of expert responses." },
