        ...
        >
          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2.5">
              <div className="h-8 w-8 rounded-full bg-th-text/10 flex items-center justify-center">
                <Phone size={16} className="text-th-text" />
              </div>
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-xs text-th-text-40 leading-5 mb-3">
                  This costs <span className="text-th-text font-semibold">{CALL_COST} coins</span> and will be deducted when you confirm your booking.
                </p>
              </div>
              ...
              <div className="flex items-center gap-2 pt-1">
                <div className="flex items-center gap-1.5 text-xs text-th-text-40">
                  <span className="inline-block h-4 w-4 rounded-full bg-th-text/15 text-th-text flex items-center justify-center text-[10px] font-bold">✓</span>
                  {CALL_COST} coins
                </div>
              ...
              <button
                ...
                className="w-full h-11 rounded-full bg-[#0f0f11] text-white font-semibold text-sm hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90 transition-colors disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                {CALENDLY_URL ? (
                  ...
                  >
                    <Calendar size={18} className="text-th-text shrink-0" />
              ...
              <div className="flex gap-2 pt-1">
                ...
                <button
                  ...
                  className="flex-1 h-11 rounded-full bg-[#0f0f11] text-white font-semibold text-sm hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90 transition-colors disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          ...
          {step === "success" && (
            <div className="flex flex-col items-center gap-5 py-4">
              <div className="h-16 w-16 rounded-full bg-th-text/10 flex items-center justify-center">
                <CheckCircle2 size={30} className="text-th-text" />
              </div>
              ...
              <button
                onClick={onClose}
                className="w-full h-11 rounded-full bg-[#0f0f11] text-white font-semibold text-sm hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90 transition-colors"
